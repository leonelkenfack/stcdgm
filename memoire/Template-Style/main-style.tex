...
\documentclass[14pt, a4paper, openany, oneside]{memoir}  % [patch] 14pt : taille de la version de base du memoire
...
\usepackage{amsmath}
\usepackage{graphicx}
% [patch pdflatex] \usepackage{pst-all} % PSTricks incompatible pdflatex, non utilise
\usepackage{ifpdf}
\usepackage{verbatim} 
\usepackage{fancyvrb}%Pour utiliser l'environnement "Verbatim"
\usepackage{mathrsfs}
% [patch] \usepackage{vmargin} % decale hoffset/voffset de -1in des le chargement
%         (jamais utilise : \setpapersize commente) ; marges gerees par geometry
\usepackage{titletoc}
\usepackage{bbding}
\usepackage{wasysym}
%\usepackage{eufrak}
